...
from src.enrich import generate_client_brief, generate_proposal  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--mode", choices=["scan", "daily_summary", "weekly_digest"], default="scan")
