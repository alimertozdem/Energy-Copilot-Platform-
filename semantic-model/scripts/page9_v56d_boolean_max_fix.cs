...
RETURN
    SWITCH( TRUE(),
        ...
        _country IN {""DE"",""AT""} && _nmc_ok = FALSE(),
            ""LFP (CATL or Fluence) — NMC chemistry banned for new installs in "" & _country & "" per BattG 2025. LFP yields 6000+ cycles and full EU 2023/1670 compliance."",
        _country = ""NL"",
        ...
        ""LFP (CATL or Fluence) — best lifecycle value, full EU 2023/1670 compliance, 12-year warranty, 6000+ cycles."" )",
"", "Page 9 / Insights");
