...
RETURN
    SWITCH( TRUE(),
        ...
        ""LFP (CATL or Fluence) — best lifecycle value, EU 2023/1670 compliant, 12-year warranty."" )",
"", "Page 9 / Insights");
...
RETURN
    SWITCH( TRUE(),
        ...
        _is_eu_member = TRUE() && _compliant = FALSE(),
            ""Active battery does not meet EU 2023/1670 thresholds. Mandatory replacement before 2027 in regulated tenders."",
