...
- Name: auth-guard.spec.ts >> auth guards + 404 >> /portfolio redirects to landing when unauthenticated
...
Call log:
  - navigating to "http://localhost:3000/portfolio", waiting until "load"
...
```yaml
- generic [ref=e13]: Loading portfolio…
```
