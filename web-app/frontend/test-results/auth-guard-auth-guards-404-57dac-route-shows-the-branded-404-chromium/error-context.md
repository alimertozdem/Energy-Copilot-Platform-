...
- Name: auth-guard.spec.ts >> auth guards + 404 >> unknown route shows the branded 404
- Location: e2e\auth-guard.spec.ts:20:7
...
Call log:
  - navigating to "http://localhost:3000/this-route-does-not-exist-xyz", waiting until "load"
