...
- Name: auth-guard.spec.ts >> auth guards + 404 >> /actions redirects to landing when unauthenticated
...
Call log:
  - navigating to "http://localhost:3000/actions", waiting until "load"
...
```yaml
- generic [ref=e13]: Loading actions…
```
