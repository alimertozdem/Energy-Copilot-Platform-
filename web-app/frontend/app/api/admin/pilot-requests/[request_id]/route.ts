/**
 * Browser proxy: PATCH /admin/pilot-requests/{request_id} (founder pipeline).
...
export async function PATCH(
  ...
  try {
    const res = await fetch(
      `${base}/admin/pilot-requests/${encodeURIComponent(request_id)}`,
      {
        method: "PATCH",
        headers: {
    ...
    console.error("[/api/admin/pilot-requests/[id] PATCH] Network error:", err)
