/**
 * Browser proxy: PATCH /admin/bridge-requests/{request_id} (approve/reject/fulfil).
...
export async function PATCH(
  ...
  try {
    const res = await fetch(
      `${base}/admin/bridge-requests/${encodeURIComponent(request_id)}`,
      {
        method: "PATCH",
        headers: {
    ...
    console.error("[/api/admin/bridge-requests/[id] PATCH] Network error:", err)
